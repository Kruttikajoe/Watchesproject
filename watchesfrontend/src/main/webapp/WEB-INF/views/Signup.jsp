...
<<<<<<< HEAD
								<form:input path="username" class="form-control" name="username" required="true" />
								<form:errors path="username"></form:errors>
							</div>
							<div class="form-group">
								<label for="email">Email</label>
								<form:input type="email" path="emailid" name="emailid" class="form-control" required="true" />
								<form:errors path="emailid"></form:errors>
							</div>
							<div class="form-group">
								<label for="Mobileno">Mobile</label>
								<form:input type="text" path="phno" name="phno" class="form-control" required="true" />
								<form:errors path="phno"></form:errors>
							</div>
							<div class="form-group">
								<label for="address">Address</label>
								<form:input type="text" path="address" name="address" class="form-control" required="true" />
								<form:errors path="address"></form:errors>
							</div>
							<div class="form-group">
								<label for="password">Password</label>
								<form:password path="password" class="form-control" name="password" required="true" />
								<form:errors path="password"></form:errors>
							</div>
							<div class="form-group">
								<label for="password">Re Enter Password</label>
								<form:password path="cpassword" class="form-control" name="cpassword" required="true"/>
